...
local FastSpawn = _Load_Library_("FastSpawn")
...
function Janitor.__index:LinkToInstance(Object, AllowMultiple)
	...
	local function ChangedFunction(Obj, Par)
		...
		elseif Obj == Reference.Value and not Par then
			Obj = nil
			task.wait()  -- Push further execution of this script to the end of the current execution cycle
	...
	--  task.spawn() starts it on the next cycle or frame, coroutines don't have ROBLOX's coroutine.yield handler
